    ...
    def checkPids(self, now):
        ...
        for c in self.activeCmds:
            ...
            if c.process and cmd_tuple in self.cidsToBeSwept:
                # Get the requested by info of the command index
                reqby = self.cidsToBeSweptReqBy[self.cidsToBeSwept.index(cmd_tuple)]
        ...
        for c in self.activeCmds:
            ...
            if c.jid == jid and c.process and \
                ...
                if action == "jdelete":
                    ...
                    self.cidsToBeSweptReqBy.append(reqby)
